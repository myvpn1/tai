...
echo -e "${BIYellow}│  ${BICyan}Jumlah Ram      : ${GREEN}${totalram}MB"
echo -e "${BIYellow}│  ${BICyan}Server Resource : $uram / $tram"
echo -e "${BIYellow}│  ${BICyan}CPU Usage       : $cpu_usage"
echo -e "${BIYellow}│  ${BICyan}Clients Name    : ${GREEN}$Name${NC}"
